...
% Pseudo code
% \usepackage[ruled, linesnumbered, vlined, noend]{algorithm2e}  % Conflicts with algorithm from class
% \usepackage[noend]{algpseudocode}  % Conflicts with algorithm2e
...
% Pseudo code (algorithm2e specific - commented out)
